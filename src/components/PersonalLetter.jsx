    ...
    return (
        ...
        <div className="pl">
            ...
            <div>
                ...
                <p>
                    One day when Huiyi was strugging with thinking up new project ideas and find finacial support at Miljöfordon as always, she downloaded Visual Studio Code and wrote her very first line of code in many years - "hello world". It didn't go well for the first time, but it felt well. And it felt right. 
